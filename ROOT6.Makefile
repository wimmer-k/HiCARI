...
all: $(LIB_DIR)/libCommandLineInterface.so $(LIB_DIR)/libHiCARI.so $(LIB_DIR)/libBigRIPS.so  $(EXTRAS) UnpackMode3 Calibrate Raw_histos Cal_histos BigRIPSTree Merge #SimCalculate Sim_histos
